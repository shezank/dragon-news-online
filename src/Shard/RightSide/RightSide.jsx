    ...
    return (
        <div className='p-4'>
            <div className=" mb-7">
                ...
                <button className="btn btn-outline btn-info rounded-md w-full mb-2"><FaGoogle></FaGoogle> Google</button>
                <button className="btn btn-outline btn-info rounded-md w-full"><FaGithub></FaGithub> Github</button>
            </div>
            <div className=''>
